...
//               <thead>
//                 <tr>
//                   {["Name","Email","Phone","Clinic","Specialty","Service","Notes","Status","Change","Actions"].map(h => (
//                     <th key={h}>{h}</th>
//                   ))}
//                 </tr>
//               </thead>
...
//                       <td style={{ whiteSpace: "normal", minWidth: "180px", maxWidth: "260px" }}><span className="notes-cell">{item.notes || "—"}</span></td>
...
//    NewRequestsDrawer
// ───────────────────────────────────────────── */
// function NewRequestsDrawer({ items, open, onClose, onStatusChange }) {
...
//         role="dialog"
//         aria-label="New consultation requests"
//         aria-modal="true"
//       >
//         {/* Drawer header */}
...
//                         </span>
//                         <span className="drawer-item-sub">{item.clinicName}</span>
//                       </div>
//                     </div>
...
//                           <span className="drawer-item-value">{item.email}</span>
//                         </div>
//                       )}
//                       {item.phoneNumber && (
//                         <div className="drawer-item-row">
//                           <span className="drawer-item-label">Phone</span>
//                           <span className="drawer-item-value">{item.phoneNumber}</span>
//                         </div>
//                       )}
//                       {item.specialty && (
//                         <div className="drawer-item-row">
//                           <span className="drawer-item-label">Specialty</span>
//                           <span className="drawer-item-value">{item.specialty}</span>
//                         </div>
//                       )}
//                       {item.serviceInterest && (
//                         <div className="drawer-item-row">
//                           <span className="drawer-item-label">Service</span>
//                           <span className="drawer-item-value">{item.serviceInterest}</span>
//                         </div>
//                       )}
//                       {item.notes && (
//                         <div className="drawer-item-row drawer-item-row--notes">
//                           <span className="drawer-item-label">Notes</span>
//                           <span className="drawer-item-value">{item.notes}</span>
//                         </div>
//                       )}
//                     </div>
...
//           {/* Bell button – opens new requests drawer */}
//           <button
//             className="bell-btn"
//             onClick={() => setDrawerOpen(true)}
//             aria-label={`View ${pendingItems.length} new consultation requests`}
//           >
...
//               <span className="bell-badge">{pendingItems.length}</span>
//             )}
//           </button>
//         </div>
//       </div>
...
//                       <span className="name-text">{item.firstName} {item.lastName}</span>
//                     </div>
//                     {/* Merged badge-select on mobile too */}
//                     <StatusSelect
//                       value={item.status || "pending"}
//                       onChange={val => handleStatusChange(id, val)}
//                     />
...
//           // If moved out of pending, it'll disappear from the drawer automatically
//         }}
//       />
